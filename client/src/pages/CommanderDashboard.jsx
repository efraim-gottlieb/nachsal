  ...
  return (
    <div>
      ...
      <Header
        ...
        navLinks={[
          { to: "/commander/soldiers", label: "👥 ניהול חיילים" },
                        ...
                        <li key={s._id} className="soldier-item">
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                            ...
                            <button
                              ...
                              onClick={async () => {
                                try {
                                  await api.overrideSoldierStatus(s._id, "ok");
                                  showToast(`${s.user_id?.name || "חייל"} סומן בסדר ✅`, "success");
                                  await loadData();
                                } catch (err) {
                                  showToast(err.message, "alert");
                                }
                            ...
                            <button
                              ...
                              onClick={async () => {
                                try {
                                  await api.overrideSoldierStatus(s._id, "not_ok");
                                  showToast(`${s.user_id?.name || "חייל"} סומן לא בסדר ❌`, "warning");
                                  await loadData();
                                } catch (err) {
                                  showToast(err.message, "alert");
                                }
